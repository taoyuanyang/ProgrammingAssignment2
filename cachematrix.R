...
##The following functions are used to create special object to store a numeric vector and cache's its mean
## and it can improve the computation efficiency.

## the function creates a special objext that store its inverse.
